...
public val SideMenuTakIcons.RoverNwConfigure: ImageVector
  get() {
    if (nullableIcon != null) {
      return nullableIcon!!
    }
    nullableIcon = ImageVector.Builder(
      name = "RoverNwConfigure",
      defaultWidth = 36.dp,
      defaultHeight = 37.dp,
      viewportWidth = 36f,
      viewportHeight = 37f,
      ...
      path(
        ...
        moveTo(17.1399f, 22.4201f)
        horizontalLineTo(17.4599f)
        verticalLineTo(21.4401f)
        curveTo(17.4599f, 20.8878f, 17.9076f, 20.4401f, 18.4599f, 20.4401f)
        horizontalLineTo(25.6999f)
        curveTo(26.2522f, 20.4401f, 26.6999f, 20.8878f, 26.6999f, 21.4401f)
        verticalLineTo(22.4201f)
        horizontalLineTo(27.0199f)
        curveTo(27.5722f, 22.4201f, 28.0199f, 22.8678f, 28.0199f, 23.4201f)
        verticalLineTo(24.4001f)
        horizontalLineTo(28.9999f)
        curveTo(29.5522f, 24.4001f, 29.9999f, 24.8478f, 29.9999f, 25.4001f)
        verticalLineTo(30.0001f)
        curveTo(29.9999f, 30.5523f, 29.5522f, 31.0001f, 28.9999f, 31.0001f)
        horizontalLineTo(15.1599f)
        curveTo(14.6076f, 31.0001f, 14.1599f, 30.5523f, 14.1599f, 30.0001f)
        verticalLineTo(25.4001f)
        curveTo(14.1599f, 24.8478f, 14.6076f, 24.4001f, 15.1599f, 24.4001f)
        horizontalLineTo(16.1399f)
        verticalLineTo(23.4201f)
        curveTo(16.1399f, 22.8678f, 16.5876f, 22.4201f, 17.1399f, 22.4201f)
        close()
        moveTo(17.4599f, 27.0401f)
        horizontalLineTo(18.7799f)
        verticalLineTo(31.0001f)
        horizontalLineTo(17.4599f)
        verticalLineTo(27.0401f)
        close()
        moveTo(20.0999f, 27.0401f)
        horizontalLineTo(21.4199f)
        verticalLineTo(31.0001f)
        horizontalLineTo(20.0999f)
        verticalLineTo(27.0401f)
        close()
        moveTo(24.0599f, 27.0401f)
        horizontalLineTo(22.7399f)
        verticalLineTo(31.0001f)
        horizontalLineTo(24.0599f)
        verticalLineTo(27.0401f)
        close()
        moveTo(25.3799f, 27.0401f)
        horizontalLineTo(26.6999f)
        verticalLineTo(31.0001f)
        horizontalLineTo(25.3799f)
        verticalLineTo(27.0401f)
        close()
      }
    }
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = SideMenuTakIcons.RoverNwConfigure)
