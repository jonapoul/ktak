...
public val SideMenuTakIcons.DownloadComplete: ImageVector
  get() {
    ...
    nullableIcon = ImageVector.Builder(
      ...
      path(
        ...
        moveTo(27f, 31f)
        curveTo(30.3137f, 31f, 33f, 28.3137f, 33f, 25f)
        curveTo(33f, 21.6863f, 30.3137f, 19f, 27f, 19f)
        curveTo(23.6863f, 19f, 21f, 21.6863f, 21f, 25f)
        curveTo(21f, 28.3137f, 23.6863f, 31f, 27f, 31f)
        close()
        moveTo(30.7965f, 23.0399f)
        curveTo(31.0487f, 22.7113f, 30.9868f, 22.2405f, 30.6582f, 21.9884f)
        curveTo(30.3296f, 21.7362f, 29.8588f, 21.7981f, 29.6066f, 22.1267f)
        lineTo(26.0185f, 26.802f)
        lineTo(24.514f, 25.386f)
        curveTo(24.2124f, 25.1021f, 23.7377f, 25.1165f, 23.4538f, 25.4181f)
        curveTo(23.17f, 25.7198f, 23.1843f, 26.1944f, 23.486f, 26.4783f)
        lineTo(25.5945f, 28.4628f)
        curveTo(25.7489f, 28.6081f, 25.9576f, 28.6813f, 26.1689f, 28.6642f)
        curveTo(26.3802f, 28.6472f, 26.5744f, 28.5415f, 26.7035f, 28.3733f)
        lineTo(30.7965f, 23.0399f)
        close()
      }
    }
      .build()
...
@Composable
@DarkPreview
private fun Preview() = PreviewIcon(icon = SideMenuTakIcons.DownloadComplete)
