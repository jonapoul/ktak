...
public val MarkersTakIcons.PresenceCurrent: ImageVector
  get() {
    ...
    nullableIcon = ImageVector.Builder(
      ...
      path(
        ...
        stroke = SolidColor(Color(0xFF297F01)),
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = MarkersTakIcons.PresenceCurrent)
