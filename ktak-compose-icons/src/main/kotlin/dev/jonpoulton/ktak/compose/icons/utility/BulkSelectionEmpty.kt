...
public val UtilityTakIcons.BulkSelectionEmpty: ImageVector
  get() {
    if (nullableIcon != null) {
      return nullableIcon!!
    }
    nullableIcon = ImageVector.Builder(
      name = "BulkSelectionEmpty",
      defaultWidth = 29.dp,
      defaultHeight = 29.dp,
      viewportWidth = 29f,
      viewportHeight = 29f,
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = UtilityTakIcons.BulkSelectionEmpty)
