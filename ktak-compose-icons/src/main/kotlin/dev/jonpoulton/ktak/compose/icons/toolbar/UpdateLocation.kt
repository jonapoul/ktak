...
public val ToolbarTakIcons.UpdateLocation: ImageVector
  get() {
    ...
    nullableIcon = ImageVector.Builder(
      ...
      path(
        ...
        moveTo(23.4294f, 24.6259f)
        curveTo(23.2868f, 24.6796f, 23.1224f, 24.6614f, 22.9938f, 24.5697f)
        lineTo(19.6957f, 22.2351f)
        lineTo(16.4447f, 24.6349f)
        curveTo(16.2777f, 24.7585f, 16.0485f, 24.7561f, 15.8834f, 24.6314f)
        curveTo(15.7171f, 24.5052f, 15.6548f, 24.285f, 15.7286f, 24.091f)
        lineTo(19.1877f, 15.0191f)
        curveTo(19.2561f, 14.8392f, 19.4264f, 14.719f, 19.6206f, 14.7172f)
        curveTo(19.8135f, 14.7153f, 19.9874f, 14.8314f, 20.0601f, 15.0103f)
        lineTo(23.6987f, 24.0118f)
        curveTo(23.7765f, 24.2041f, 23.7184f, 24.4256f, 23.5548f, 24.5546f)
        curveTo(23.5162f, 24.5852f, 23.4739f, 24.6091f, 23.4294f, 24.6259f)
        close()
      }
    }
      .build()
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = ToolbarTakIcons.UpdateLocation)
