...
public val MarkersTakIcons.DoubleRoundGreen: ImageVector
  get() {
    if (nullableIcon != null) {
      return nullableIcon!!
    }
    nullableIcon = ImageVector.Builder(
      name = "DoubleRoundGreen",
      ...
      path(
        fill = SolidColor(Color(0xFF297F01)),
        stroke = null,
      ...
      path(
        ...
        stroke = SolidColor(Color(0xFF5CFF00)),
        fillAlpha = 0.6f,
        strokeAlpha = 0.6f,
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = MarkersTakIcons.DoubleRoundGreen)
