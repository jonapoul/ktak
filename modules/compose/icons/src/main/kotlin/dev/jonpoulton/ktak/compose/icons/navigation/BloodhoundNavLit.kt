...
public val NavigationTakIcons.BloodhoundNavLit: ImageVector
  get() {
    if (nullableIcon != null) {
      return nullableIcon!!
    }
    nullableIcon = ImageVector.Builder(
      name = "BloodhoundNavLit",
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = NavigationTakIcons.BloodhoundNavLit)
