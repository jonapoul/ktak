...
public val SideMenuTakIcons.ListView: ImageVector
  get() {
    ...
    nullableIcon = ImageVector.Builder(
      ...
      path(
        ...
        arcToRelative(1.92f, 1.92f, 0f, true, true, 3.84f, 0f)
        arcToRelative(1.92f, 1.92f, 0f, true, true, -3.84f, 0f)
      }
      path(
        fill = SolidColor(TakColors.Sand),
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = SideMenuTakIcons.ListView)
