...
public val NavigationTakIcons.RoverReceptionEnabled1: ImageVector
  get() {
    if (nullableIcon != null) {
      return nullableIcon!!
    }
    nullableIcon = ImageVector.Builder(
      name = "RoverReceptionEnabled1",
...
@Composable
@PreviewDark
private fun Preview() = PreviewIcon(icon = NavigationTakIcons.RoverReceptionEnabled1)
